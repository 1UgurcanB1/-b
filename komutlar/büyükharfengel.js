...
exports.run = async (client, message, args) => {
  ...
  if (capslock) {
    ...
    message.channel.send(`:fire: TRCyber|Capslock engelleme sistemi, kapatıldı!`)
  }
  if (!capslock) {
    db.set(`capslock_${message.guild.id}`, 'acik')
    message.channel.send(`:fire: TRCyber|Capslock engelleme sistemi, aktif!`)
